        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "text", nullable: true, defaultValue: "default.png"),
                    UserPhotoId = table.Column<int>(type: "integer", nullable: true),
                    IsBanned = table.Column<bool>(type: "boolean", nullable: false),
                    RegistrationDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AppFiles_ContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticeContentId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PracticeOrders_AppFiles_PracticeContentId",
                        column: x => x.PracticeContentId,
                        principalTable: "AppFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PracticeOrders_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PracticeOrders_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeOrders_AuthorId",
                table: "PracticeOrders",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeOrders_LessonId",
                table: "PracticeOrders",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeOrders_PracticeContentId",
                table: "PracticeOrders",
                column: "PracticeContentId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeOrders_TeacherId",
                table: "PracticeOrders",
                column: "TeacherId");
